...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F6,     spawn,          SHCMD("~/.config/dmenu/scripts/dmenu-power.sh") },
	{ MODKEY,                       XK_F7,     spawn,          SHCMD("~/.config/dmenu/scripts/dmenu-ssh.sh") },
	{ MODKEY,                       XK_F8,     spawn,          SHCMD("~/.config/dmenu/scripts/dmenu-sysmon.sh") },
	{ MODKEY,                       XK_F9,     spawn,          SHCMD("~/.config/dmenu/scripts/dmenumount.sh") },
	{ MODKEY,                       XK_F10,    spawn,          SHCMD("~/.config/dmenu/scripts/dmenuumount.sh") },
	{ MODKEY,                       XK_F11,    spawn,          SHCMD("~/.config/dmenu/scripts/dmenu-scrot.sh") },
	{ MODKEY,                       XK_F12,    spawn,          SHCMD("~/.config/dmenu/scripts/dmenu-edit-configs.sh") },
