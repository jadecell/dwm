...
static Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_u, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-unicode.sh")},
    {MODKEY | ControlMask, XK_p, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-power.sh")},
    ...
    {MODKEY | ControlMask, XK_b, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-bookmarks.sh")},
    {MODKEY | ControlMask | ShiftMask, XK_b, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-browse.sh")},
    {MODKEY | ControlMask, XK_y, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-sysmon.sh")},
    {MODKEY | ControlMask, XK_m, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-mount.sh")},
    {MODKEY | ControlMask | ShiftMask, XK_m, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-umount.sh")},
    {MODKEY | ControlMask, XK_e, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-edit-configs.sh")},
    {MODKEY | ControlMask, XK_c, spawn,
     SHCMD("~/.config/dmenu/scripts/dmenu-calc.sh")},
    ...
    {0, XF86XK_AudioPlay, spawn,
     SHCMD("/home/jackson/.local/bin/music-control toggle")},
    {0, XF86XK_AudioPrev, spawn,
     SHCMD("/home/jackson/.local/bin/music-control prev")},
    {0, XF86XK_AudioNext, spawn,
     SHCMD("/home/jackson/.local/bin/music-control next")},
    {0, XF86XK_AudioStop, spawn,
     SHCMD("/home/jackson/.local/bin/music-control stop")},
    {MODKEY | ShiftMask, XK_q, spawn, SHCMD("/home/jackson/.local/bin/sysact")},
    {MODKEY, XK_n, spawn,
     SHCMD(TERMINAL " -e newsboat")},
    {MODKEY, XK_t, spawn, SHCMD(TERMINAL " -e stig")},
    {MODKEY | ShiftMask, XK_t, spawn, SHCMD("/home/jackson/.local/bin/starttorrent")},
    {MODKEY, XK_m, spawn, SHCMD(TERMINAL " -e ncmpcpp")},
    {MODKEY | ShiftMask, XK_m, spawn, SHCMD(TERMINAL " -e neomutt")},
    {MODKEY | ShiftMask, XK_v, spawn, SHCMD("/home/jackson/.local/bin/togglevpn")},
    {MODKEY, XK_u, spawn, SHCMD(TERMINAL " -e /home/jackson/.local/bin/update-system")},
