...
static char *fonts[]                = { "Fira Code Nerd Font:size=10", "JoyPixels:pixelsize=11:antialias=true:autohint=true"  };
...
#endif
	{ ClkStatusText,        ShiftMask,      Button3,        spawn,          SHCMD("emacsclient -c -n -a emacs ~/.local/repos/dwmblocks/config.h") },
